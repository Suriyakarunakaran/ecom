					...
					<input type="hidden" class="cat" value="<?php echo $cat1?>"/>
							...
							<?php 
								...
								if (isset($_POST['search'])) {
									...
									$wheres .= "product_name LIKE '%$search1%'";
								}
								$s_no1=0;				
					...
					<div class="col-12 col-lg-9 order-lg-3">
						...
						<article id="content">
							...
							<div class="row pro">
								...
								<?php 
									$s_no='1';
									$UserListN = mysqli_query($conn,"SELECT * FROM products ");
					...
					<div class="col-12 col-lg-3 order-lg-1">	
						...
						<aside id="sidebar">
							...
							<section class="widget mb-9">
								...
								<form action="category.php" method="post" class="filter-ranger-form">
...
$j( function() {
		<?php  
	$hashtag_get = mysqli_query($conn,"SELECT product_name FROM products ");
