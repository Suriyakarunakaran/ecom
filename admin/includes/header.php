<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="../index.php"><h3 style="color: white">Evara</h3></a>
          <a class="navbar-brand brand-logo-mini" href="../index.php"><h3 style="color: white">Evara</h3></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <?php
                    $get_mobile = $_SESSION['mobile'];
                    $query_1 = "SELECT * FROM register WHERE mobile='$get_mobile'";
                    $results_1 = mysqli_query($conn, $query_1);
                    $results_1 = mysqli_fetch_array($results_1);
                    $user_name = $results_1['name']; { ?>
